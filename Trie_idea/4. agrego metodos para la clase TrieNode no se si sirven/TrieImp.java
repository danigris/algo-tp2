...
public class TrieImp {
    ...
    public class TrieNode<T extends Comparable<T>> {  // le agrego comparabilidad, no se...
        T valor;
        boolean end;
    ...
    public void insert(String word , Integer v) {   // acá es donde necesito poner un tipo paramétrico
        ...
        while (true) {
            ...
            try {
                ...
                case 1:
                    word = scan.next();
                    if (isValid(word)) {
                        obj.insert(word, 33);      // atención que acá metí un parametro string
                    } else {
